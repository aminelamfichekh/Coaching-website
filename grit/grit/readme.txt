...
WordPress version: required at least 5.0, tested up to 6.0.3
...
Please install and activate it before starting to use the theme Grit.
...
Theme documentation is available on https://grit.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Grit is Fontello.
