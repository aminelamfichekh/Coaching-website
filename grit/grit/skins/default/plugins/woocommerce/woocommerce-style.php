...
if ( ! function_exists( 'grit_woocommerce_get_css' ) ) {
	add_filter( 'grit_filter_get_css', 'grit_woocommerce_get_css', 10, 2 );
	function grit_woocommerce_get_css( $css, $args ) {
...
$fdir = grit_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
