...
if ( ! function_exists( 'grit_trx_addons_get_css' ) ) {
	add_filter( 'grit_filter_get_css', 'grit_trx_addons_get_css', 10, 2 );
	function grit_trx_addons_get_css( $css, $args ) {
...
.sc_blogger_portestate .sc_blogger_item.cpt_portfolio .sc_blogger_item_content .sc_blogger_item_meta .post_meta_item.post_categories,
